    ...
    <section>
        <div class="row mt-4">
            <div class="col-6">
                ...
                <span>${ctsp.sanPham.ten}</span>
            </div>
            <div class="col-6">
                <label><b>Tên NSX: </b></label>
                <span>${ctsp.nhaSanXuat.ten}</span>
            </div>
        </div>

        <div class="row mt-4">
            <div class="col-6">
                <label><b>Tên MS: </b></label>
                <span>${ctsp.mauSac.ten}</span>
            </div>
            <div class="col-6">
                <label><b>Tên DongSP: </b></label>
                <span>${ctsp.dongSP.ten}</span>
            </div>
        </div>
