...
import com.example.Tiepnmph25816_Java4_Assigment.service.ChiTietSPService;
...
import com.example.Tiepnmph25816_Java4_Assigment.service.impl.ChiTietSPServiceImpl;
import com.example.Tiepnmph25816_Java4_Assigment.service.impl.DongSPServiceImpl;
import com.example.Tiepnmph25816_Java4_Assigment.service.impl.MauSacServiceImpl;
import com.example.Tiepnmph25816_Java4_Assigment.service.impl.NhaSanXuatServiceImpl;
import com.example.Tiepnmph25816_Java4_Assigment.service.impl.SanPhamServiceImpl;
...
public class ChiTietSPServlet extends HttpServlet {
    ...
    private void update(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        ctsp.setNhaSanXuat(nhaSanXuatService.getOne(UUID.fromString(request.getParameter("nhaSanXuat"))));
    ...
    private void add(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ChiTietSP chiTietSP = ChiTietSP.builder()
                ...
                .nhaSanXuat(nhaSanXuatService.getOne(UUID.fromString(request.getParameter("nhaSanXuat"))))
    ...
    private void viewUpdate(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.setAttribute("listNSX", nhaSanXuatService.getAll());
